...
if __name__ == '__main__':
    ...
    thread_configs = [
        {"name": "1 поток", "threads": 1, "color": "red", "marker": "o"},
        {"name": "2 потока", "threads": 2, "color": "blue", "marker": "s"},
        {"name": "4 потока", "threads": 4, "color": "green", "marker": "^"},
        {"name": "8 потоков", "threads": 8, "color": "purple", "marker": "D"},
    ]
    ...
    for cfg in thread_configs:
        plt.plot(sizes, results[cfg["name"]],
